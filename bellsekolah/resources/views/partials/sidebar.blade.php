<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('monday.index')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">event</i>
                    </div>
                    <span class="nav-link-text ms-1">Monday Schedules</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('tuesday.index')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">today</i>
                    </div>
                    <span class="nav-link-text ms-1">Tuesday Schedules</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('wednesday.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Wednesday Schedules</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('thursday.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Thursday Schedules</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('friday.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Friday Schedules</span>
                </a>
            </li>
            {{-- <li class="nav-item">
