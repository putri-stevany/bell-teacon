    ...
    <div class="container-fluid py-4">
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <!-- Form input -->
                    <form action="{{route('sesi2')}}" method="POST" enctype="multipart/form-data" class="form-inline d-flex justify-content-between">
                        {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-12">
                    @foreach ($scheduleData as $day => $daySchedule)
                        <div class="mb-4">
                            @include('sesi2.schedule-sesi2', ['day' => $day, 'daySchedule' => $daySchedule])
                        </div>
                    @endforeach
                </div>
            </div>
