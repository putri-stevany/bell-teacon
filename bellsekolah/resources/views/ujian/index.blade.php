        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ujian Schedules</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Ujian Schedules</h6>
          </nav>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <!-- Form input -->
                    <form action="{{route('ujian')}}" method="POST" enctype="multipart/form-data" class="form-inline d-flex justify-content-between">
                        {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-12">
                    @foreach ($scheduleData as $day => $daySchedule)
                        <div class="mb-4">
                            @include('ujian.schedule-ujian', ['day' => $day, 'daySchedule' => $daySchedule])
                        </div>
                    @endforeach
                </div>
            </div>
